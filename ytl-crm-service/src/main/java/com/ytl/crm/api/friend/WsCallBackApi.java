...
//        try {
//            String type = Json.getPathObject(json, String.class, "type");
//            String content = Json.getPathObject(json, String.class, "content");
//            String messageId = Json.getPathObject(json, String.class, "message_id");
...
//                    break;
//                case GROUP_CHANGE:
//                    log.info("微盛企微回调入参(群)：{}", json);
//                    UserContext.setUser(new OperatorRequest(Constants.ZIROOM, Constants.ZIROOM));
//                    WsCallBackGroupContent wsCallBackGroupContent = Json.parseObject(content, WsCallBackGroupContent.class);
//                    wechatGroupLogicService.callBackGroupLogic(messageId, wsCallBackGroupContent);
//                    break;
//                default:

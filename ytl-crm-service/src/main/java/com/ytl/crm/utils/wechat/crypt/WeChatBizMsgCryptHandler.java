...
public class WeChatBizMsgCryptHandler {
     ...
     */
    public WeChatBizMsgCryptHandler(String token, String encodingAesKey, String receiveid) throws AesException {
    ...
    public WeChatBizMsgCryptHandler() {
        base64 = new Base64();
    }
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String extractMsgData(String msgSignature, String timeStamp, String nonce, String postData) throws AesException {

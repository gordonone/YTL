...
//     * @param content   事件内容
//     */
//    @RedissonLock(value = "{#messageId}", waitTime = 0L)
...
//        LambdaQueryWrapper<WechatFriendChangeEventEntity> queryWrapper = Wrappers.lambdaQuery(WechatFriendChangeEventEntity.class)
//                .select(WechatFriendChangeEventEntity::getId)
//                .eq(WechatFriendChangeEventEntity::getMessageId, messageId)
//                .eq(WechatFriendChangeEventEntity::getIsDelete, YesOrNoEnum.NO.getCode())
//                .last("limit 1");
//
...
//        LambdaQueryWrapper<WechatFriendRelationEntity> queryWrapper = Wrappers.lambdaQuery(WechatFriendRelationEntity.class)
//                .select(WechatFriendRelationEntity::getId)
//                .eq(WechatFriendRelationEntity::getVirtualEmpThirdId, applyQrcodeLogEntity.getVirtualEmpThirdId())
//                .eq(WechatFriendRelationEntity::getUserExternalId, changeEvent.getExternalUserId())
//                .eq(WechatFriendRelationEntity::getStatus, WechatFriendRelationStatusEnum.DELETED.getCode())
//                .last("limit 1");
//
...
//            wechatFriendRelationEntity.setLogicCode(UUIDGeneratorUtil.hexUUID());
...
//        LambdaQueryWrapper<WechatFriendRelationEntity> queryWrapper = Wrappers.lambdaQuery(WechatFriendRelationEntity.class)
//                .select(WechatFriendRelationEntity::getId)
//                .eq(WechatFriendRelationEntity::getVirtualEmpThirdId, empThirdId)
//                .eq(WechatFriendRelationEntity::getUserExternalId, userExternalId)
//                .eq(WechatFriendRelationEntity::getStatus, WechatFriendRelationStatusEnum.ADDED.getCode())
//                .last("limit 1");
//
...
//                .select(WechatApplyQrcodeLogEntity::getResBlockId, WechatApplyQrcodeLogEntity::getVirtualEmpId,
//                        WechatApplyQrcodeLogEntity::getVirtualEmpThirdId, WechatApplyQrcodeLogEntity::getUid,
//                        WechatApplyQrcodeLogEntity::getUserName, WechatApplyQrcodeLogEntity::getId,
//                        WechatApplyQrcodeLogEntity::getContractCode, WechatApplyQrcodeLogEntity::getChannelCode,
//                        WechatApplyQrcodeLogEntity::getContractType)
//                .eq(WechatApplyQrcodeLogEntity::getState, state)
//                .eq(WechatApplyQrcodeLogEntity::getIsDelete, YesOrNoEnum.NO.getCode())
//                .last("limit 1");
